# Governor v0.2.1 build 5 — UNNOTARIZED manual-install pre-release
...
- A real session-authorization prompt was completed successfully on the
  release-validation Mac.
